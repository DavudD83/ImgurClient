...
class LoadGalleriesInteractor @Inject constructor(
    ...
    private var galleries = emptyList<com.example.base_galleries.Gallery>()
    ...
    fun start() {
        Flowable
            ...
            .subscribe { newGalleries ->
                val updatedGalleries: List<com.example.base_galleries.Gallery> = galleries + newGalleries
    ...
    private fun loadGalleriesInternal(): Single<List<com.example.base_galleries.Gallery>> {
    ...
    interface Listener {
        ...
        fun showGalleries(galleries: List<com.example.base_galleries.Gallery>)
    }
}