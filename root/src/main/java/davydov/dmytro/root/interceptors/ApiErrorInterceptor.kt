...
@RootScope
class ApiErrorInterceptor @Inject constructor(private val objectMapper: ObjectMapper) :
    Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        return if (response.isSuccessful) {
            ...
            try {
                val errorResponse =
                    objectMapper.readValue(response.body!!.byteStream(), ErrorResponse::class.java)
